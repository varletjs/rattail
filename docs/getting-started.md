...
`Rattail` is a [Vite+](https://viteplus.dev) oriented, AI Agent friendly front-end toolchain.
...
- <span style="font-size: 0.82em">🚀</span> &nbsp; Progressive HTTP client based on [axios](https://axios-http.com), with [Vue](https://vuejs.org) Composition API support.
...
- <span style="font-size: 0.82em">📄</span> &nbsp; [MIT](https://github.com/varletjs/rattail/blob/main/LICENSE) licensed.
